...
import StepPermanencia from 'components/Molecules/Steps/StepPermanencia'
import FormManager from './FormManager'

const FormPermanencia = () => {
  ...
  return (
    <Wrapper bgImage={bgImage}>
      <FormWrapper z={2}>
        ...
        <FormStep>
          <StepPermanencia indexActived={currentStep} lineWidth={60} />
        </FormStep>
        <FormFooter>
          <FormFooterAuthor>
...
export default FormPermanencia
