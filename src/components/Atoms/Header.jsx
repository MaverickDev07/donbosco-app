...
class Header extends Component {
  ...
  componentDidMount() {
    ...
    this.header.current.style.height = String(
    ...
    return (
      ...
      >
        ...
        >
          ...
          <aside
            className={`${
              this.state.scroller ? 'Header-action' : 'HeaderFixed-action'
            }`}
          >
            <h1
              className={`${
                this.state.scroller
                  ? 'Header-action--title'
                  : 'HeaderFixed-action--title'
              }`}
            >
              {back ? (
                <span
                  className={`${
                    this.state.scroller ? 'Header-back' : 'HeaderFixed-back'
                  }`}
                >
                  <IconButton
